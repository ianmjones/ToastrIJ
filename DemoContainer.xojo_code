#tag WebPage
Begin WebContainer DemoContainer
   Compatibility   =   ""
   Cursor          =   0
   Enabled         =   True
   Height          =   422
   ...
   Begin WebLabel MessageLabel
      ...
      _VerticalPercent=   0.0
   End
   Begin WebTextArea MessageInput
      Cursor          =   0
      Enabled         =   True
      HasFocusRing    =   True
      Height          =   112
      ...
      Style           =   "-1"
      TabOrder        =   2
      Text            =   "This is a little bit of text to show in a message."
      TextAlign       =   0
      Top             =   152
      VerticalCenter  =   0
      Visible         =   True
...
#tag Events DisplayButton
	...
	#tag EndEvent
#tag EndEvents
#tag Events TypeInput
	#tag Event
		Sub Shown()
		  dim types as Dictionary = ToastrIJ.TypeNames
		  
		  for each type as ToastrIJ.Type in types.Keys
		    me.AddRow types.Value(type)
		    me.RowTag(me.ListCount - 1) = type
		  next
